...
With [SkillCheck](https://skillpanel.com) you can assess your candidates'
...
perspective](https://help.skillpanel.com/space/FC/2896625792/How+the+TalentScore+test+looks+like+from+the+candidate's+perspective).
...
projects](https://help.skillpanel.com/space/TSG/2897838124/Getting+started+with+Programming+Tasks) guide first**

## Technical details

Any project which uses **pyproject.toml** can be used as a
...
Check out our [pyproject.toml](pyproject.toml) file.
...
[documentation](https://help.skillpanel.com/space/TSG/2897412197/Programming+task+project+descriptor).
...
In our sample project all verification tests are in the `VerifyTestTransformer`
